...
<head>
<meta charset="utf-8">
<title>JOB JUAN / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (043) 726 5826</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Job Juan<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          San Juan Municipal Hall (New)<br>
          QCR4+W79, Bayan ng San Juan, Batangas</address>
          <p>
            <i class="icon-phone"></i> (043) 726 5826 <br>
            <i class="icon-envelope-alt"></i> gsosanjuanbatangaslgu@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; 2023 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
          <ul class="social-network">
            <li><a href="https://www.facebook.com/PublicEmploymentServiceOfficeSJB" data-placement="top" title="Facebook"><i class="fa fa-facebook"></i></a></li>
